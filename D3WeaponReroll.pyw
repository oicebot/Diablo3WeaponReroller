...
class Application_ui(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.master.title(u'暗黑3武器附魔计算器 v0.13')
        self.master.geometry(u'390x450')
    ...
    def createWidgets(self):
        ...
        self.style.configure('TFrame2.TLabelframe.Label', font=(u'宋体',10))
        self.Frame2 = LabelFrame(self.top, text=u'武器白字估算值', style='TFrame2.TLabelframe')
        self.Frame2.place(relx=0.02, rely=0.37, relwidth=0.964, relheight=0.17)

        self.style.configure('TFrame1.TLabelframe', font=(u'宋体',9))
        self.style.configure('TFrame1.TLabelframe.Label', font=(u'宋体',10))
        self.Frame1 = LabelFrame(self.top, text=u'可能洗出的结果', style='TFrame1.TLabelframe')
        self.Frame1.place(relx=0.02, rely=0.55, relwidth=0.964, relheight=0.415)
        ...
        self.style.configure('TLabel1.TLabel', anchor='w', font=(u'宋体',10))
        self.Label1 = Label(self.top, text=u'第一步，选择武器类型、是否远古：', style='TLabel1.TLabel')
        self.Label1.place(relx=0.02, rely=0.018, relwidth=0.58, relheight=0.038)
        ...
        self.Label_DMG_result.place(relx=0.021, rely=0.1, relwidth=0.936, relheight=0.704)

        self.Label_Reroll_Result4_Var = StringVar(value='0')
        self.style.configure('TLabel_Reroll_Result.TLabel', anchor='center', font=(u'微软雅黑',26))
        self.Label_Reroll_Result4 = Label(self.Frame1, textvariable=self.Label_Reroll_Result4_Var, style='TLabel_Reroll_Result.TLabel')
        self.Label_Reroll_Result4.place(relx=0.276, rely=0.750, relwidth=0.707, relheight=0.25)
        ...
        self.Label_Reroll_Result3.place(relx=0.276, rely=0.500, relwidth=0.707, relheight=0.25)
        ...
        self.Label_Reroll_Result2.place(relx=0.276, rely=0.250, relwidth=0.707, relheight=0.25)
        ...
        self.Label_Reroll_Result1.place(relx=0.276, rely=0.01, relwidth=0.707, relheight=0.25)

        #-----------------------
        self.style.configure('TLabel2.TLabel', anchor='e', font=(u'宋体',9))
        self.Label2 = Label(self.Frame1, text=u'攻速洗成10ed时：', style='TLabel2.TLabel')
        self.Label2.place(relx=0.08, rely=0.75, relwidth=0.25, relheight=0.186)

        self.style.configure('TLabel2.TLabel', anchor='e', font=(u'宋体',9))
        self.Label2 = Label(self.Frame1, text=u'洗出7速时：', style='TLabel2.TLabel')
        self.Label2.place(relx=0.08, rely=0.50, relwidth=0.25, relheight=0.186)

        self.style.configure('TLabel2.TLabel', anchor='e', font=(u'宋体',9))
        self.Label2 = Label(self.Frame1, text=u'洗出10ed时：', style='TLabel2.TLabel')
        self.Label2.place(relx=0.08, rely=0.25, relwidth=0.25, relheight=0.186)

        self.style.configure('TLabel2.TLabel', anchor='e', font=(u'宋体',9))
        self.Label2 = Label(self.Frame1, text=u'白字洗到满时：', style='TLabel2.TLabel')
        self.Label2.place(relx=0.08, rely=0.01, relwidth=0.25, relheight=0.186)
...
class Application(Application_ui):
    ...
    def Caculate(self, event=None):
        ...
        Result4 = W_BaseSPD * (W_BaseDMG + (W_Low_DMG + W_Hig_DMG) / 2) * 1.1
        ...
        self.Label_Reroll_Result4_Var.set('%.1f' % Result4)
